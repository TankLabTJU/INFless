...
- Guideline to build and install faas-cli tool is available  [here](https://github.com/TankLabTJU/INFless/sourceCode/Go/src/github.com/openfaas/faas-cli/README.md). 
- Guideline to build and install gateway is available  [here](https://github.com/TankLabTJU/INFless/sourceCode/Go/src/github.com/openfaas/faas/gateway/README.md). 
- Guideline to build and install faas-netes is available  [here](https://github.com/TankLabTJU/INFless/sourceCode/Go/src/github.com/openfaas/faas-netes/README.md). 
...
- Guideline to build and install loadGen is available [here](https://github.com/TankLabTJU/INFless/sourceCode/Java/LoadGen/README.md).
