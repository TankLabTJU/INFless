...
clc
clear
data=[0.705882353	0.911764706	0.929411765	1;
0.294117647	0.318627451	0.333333333	0.343137255;
0.205882353	0.205882353	0.205882353	0.210784314
...
plot(-1,-1,'MarkerFaceColor',[255 127 14]/255,...
    'MarkerEdgeColor','none',...
    'MarkerSize',11,...
    'Marker','square',...
    'LineWidth',3,...
    'Color',[255 127 14]/255);
plot(-1,-1,'MarkerFaceColor',[214 39 40]/255,...
    'MarkerEdgeColor','none',...
    'MarkerSize',11,...
    'Marker','square',...
    'LineWidth',3,...
...
set(gca,'xticklabels',{'0' ,'150'  ,'200',  '250', '300'});
...
set(gca,'ycolor',[128 128 128]/255);
 xlabel('Latnecy (ms)', 'Fontsize' ,figureSize,'Color',[0 0 0])
