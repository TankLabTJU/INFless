clc
clear
load latency_partition_150ms;
data=latency_partition_150ms;
...
hold(axes1,'all'); 
    ...
    plot(-1,-1,'DisplayName','batch-4','MarkerFaceColor',[0.12156862745098 0.466666666666667 0.705882352941177],...
    'MarkerEdgeColor','none',...
    'MarkerSize',18,...
    'Marker','square',...
    'LineStyle','none',...
    'Color',[0.12156862745098 0.466666666666667 0.705882352941177]);
...
set(gca,'XLim',[0 150]);%X轴的数据显示范围
set(gca,'XTick',[0:50:150]);%设置要显示坐标刻度
set(gca,'xticklabels',[0:50:150]);%设置要显示坐标刻度 
