 ...
 *
 */
public class SocialNetworkDriver3 extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SocialNetworkDriver3 driver=null;	
	
	public SocialNetworkDriver3(){initVariables();}
	public synchronized static SocialNetworkDriver3 getInstance() {
		if (driver == null) {
			driver = new SocialNetworkDriver3();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=queryItemsStr.replace("Port", "30303");
	}
