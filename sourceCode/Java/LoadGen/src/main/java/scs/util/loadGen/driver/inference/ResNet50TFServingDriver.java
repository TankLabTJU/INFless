 ...
 *
 */
public class ResNet50TFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static ResNet50TFServingDriver driver=null;	
	public ResNet50TFServingDriver(){initVariables();}
	public synchronized static ResNet50TFServingDriver getInstance() {
		if (driver == null) {
			driver = new ResNet50TFServingDriver();
		}
		return driver;
	}
