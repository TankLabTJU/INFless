 ...
 *
 */
public class SdcbenchYamNetDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SdcbenchYamNetDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public SdcbenchYamNetDriver(){initVariables();}
	public synchronized static SdcbenchYamNetDriver getInstance() {
		if (driver == null) {
			driver = new SdcbenchYamNetDriver();
		}
		return driver;
	}
