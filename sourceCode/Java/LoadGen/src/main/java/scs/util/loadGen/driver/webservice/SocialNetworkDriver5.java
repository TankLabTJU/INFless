 ...
 *
 */
public class SocialNetworkDriver5 extends AbstractJobDriver {
	/**
	 * Singleton code block
	 */
	private static SocialNetworkDriver5 driver=null;	
	
	public SocialNetworkDriver5(){initVariables();}
	public synchronized static SocialNetworkDriver5 getInstance() {
		if (driver == null) {
			driver = new SocialNetworkDriver5();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=queryItemsStr.replace("Port", "30305");
	}
