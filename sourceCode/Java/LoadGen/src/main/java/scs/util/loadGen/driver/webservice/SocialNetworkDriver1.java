 ...
 *
 */
public class SocialNetworkDriver1 extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SocialNetworkDriver1 driver=null;	
	
	public SocialNetworkDriver1(){initVariables();}
	public synchronized static SocialNetworkDriver1 getInstance() {
		if (driver == null) {
			driver = new SocialNetworkDriver1();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=queryItemsStr.replace("Port", "30301");
	}
