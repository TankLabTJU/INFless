 ...
 *
 */
public class SocialNetworkDriver6 extends AbstractJobDriver {
	/**
	 * Singleton code block
	 */
	private static SocialNetworkDriver6 driver=null;	
	
	public SocialNetworkDriver6(){initVariables();}
	public synchronized static SocialNetworkDriver6 getInstance() {
		if (driver == null) {
			driver = new SocialNetworkDriver6();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=queryItemsStr.replace("Port", "30306");
	}
