...
import scs.util.loadGen.threads.LoadExecThreadSocailNetworkSpec;
 ...
 *
 */
public class SdcbenchSocialNetworkDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SdcbenchSocialNetworkDriver driver=null;	
	
	public SdcbenchSocialNetworkDriver(){initVariables();}
	public synchronized static SdcbenchSocialNetworkDriver getInstance() {
		if (driver == null) {
			driver = new SdcbenchSocialNetworkDriver();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		//curl -d '{"n": 15000}' http://192.168.1.106:30300
	}
