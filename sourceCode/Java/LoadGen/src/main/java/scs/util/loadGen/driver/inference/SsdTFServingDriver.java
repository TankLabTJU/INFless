 ...
 *
 */
public class SsdTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SsdTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public SsdTFServingDriver(){initVariables();}
	public synchronized static SsdTFServingDriver getInstance() {
		if (driver == null) {
			driver = new SsdTFServingDriver();
		}
		return driver;
	}
