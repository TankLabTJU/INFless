 ...
 *
 */
public class ResNetTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static ResNetTFServingDriver driver=null;	
	public ResNetTFServingDriver(){initVariables();}
	public synchronized static ResNetTFServingDriver getInstance() {
		if (driver == null) {
			driver = new ResNetTFServingDriver();
		}
		return driver;
	}
