 ...
 *
 */
public class YamNetTFServingDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static YamNetTFServingDriver driver=null;	
	
	//private StringBuilder builder=new StringBuilder();
	
	public YamNetTFServingDriver(){initVariables();}
	public synchronized static YamNetTFServingDriver getInstance() {
		if (driver == null) {
			driver = new YamNetTFServingDriver();
		}
		return driver;
	}
