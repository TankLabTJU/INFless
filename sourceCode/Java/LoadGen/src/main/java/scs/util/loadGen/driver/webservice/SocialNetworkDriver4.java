 ...
 *
 */
public class SocialNetworkDriver4 extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SocialNetworkDriver4 driver=null;	
	
	public SocialNetworkDriver4(){initVariables();}
	public synchronized static SocialNetworkDriver4 getInstance() {
		if (driver == null) {
			driver = new SocialNetworkDriver4();
		}
		return driver;
	}
	...
	protected void initVariables() {
		...
		queryItemsStr=queryItemsStr.replace("Port", "30304");
	}
