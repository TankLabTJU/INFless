...
public class Repository{ 
	...
	private final static int NUMBER_LC=20; //number of LC services 
	...
	public static String mlParmStr="";
	
	//cuiys_load
	public static String bkinfoBaseURL="";
	public static String bkinfoParmStr="";
	/**
	 * static code
	 */
	static {
	...
	private static void readProperties(){
		...
		Repository.mlBaseURL=prop.getProperty("mlBaseURL").trim();
		Repository.mlParmStr=prop.getProperty("mlParmStr").trim();
		
		//cuiys_load
		Repository.bkinfoBaseURL=prop.getProperty("bkinfoBaseURL").trim();
		Repository.bkinfoParmStr=prop.getProperty("bkinfoParmStr").trim();
