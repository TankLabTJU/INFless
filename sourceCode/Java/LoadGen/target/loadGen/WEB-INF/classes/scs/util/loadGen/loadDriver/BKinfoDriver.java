 ...
 *
 */
public class BKinfoDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static BKinfoDriver driver=null;	
	public BKinfoDriver(){initVariables();}
	public synchronized static BKinfoDriver getInstance() {
		if (driver == null) {
			driver = new BKinfoDriver();
		}
		return driver;
	}
...
//		jsonParmStr=Repository.mlParmStr;
		queryItemsStr=Repository.bkinfoBaseURL;
		jsonParmStr=Repository.bkinfoParmStr;
	}
